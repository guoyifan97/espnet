...
# You must download dataset from following kaggle HP (need to login) before run this script.
# - Kaggle HP: https://www.kaggle.com/bryanpark/the-world-english-bible-speech-dataset
# And you put all of unzip files in db_root directory.
# Example of the directory structure as follows:
# downloads/TWEB
# ├── Acts
# ├── Amos
# ├── Chronicles(1)
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    local/data_prep.sh ${db_root} data/${org_set}
