...
nbpe=1000
bpemode=bpe
# NOTE: nbpe=69 means character-level ASR (src_case=lc.rm)
# NOTE: nbpe=84 means character-level ASR (src_case=lc)
# NOTE: nbpe=110 means character-level ASR (src_case=tc)
...
nlsyms=data/lang_1spm/non_lang_syms_${src_case}.txt
