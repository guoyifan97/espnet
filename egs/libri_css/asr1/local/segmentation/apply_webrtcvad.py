...
def get_args():
    parser = argparse.ArgumentParser(
        ...
        """E.g.: apply_webrtcvad.py --aggressiveness 2 --reco2channels
        data/reco2channels data""",
    ...
    parser.add_argument(
        ...
        dest="mode",
        default=1,
        help="""Integer in {0,1,2,3} specifying the VAD aggressiveness.
    ...
    parser.add_argument(
        ...
        type=str,
        dest="reco2ch_file",
        help="""In multi-channel setting, specifying this
        would avoid computing VAD for each channel
        separately. Only first channel will be used
        to compute VAD and all channels will share.""",
    )
