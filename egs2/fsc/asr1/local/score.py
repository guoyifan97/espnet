...
valid_hyp_file = open(
    os.path.join(
        exp_root, "inference_asr_model_valid.acc.ave_5best/valid/score_wer/hyp.trn"
    )
)
valid_ref_file = open(
    os.path.join(
        exp_root, "inference_asr_model_valid.acc.ave_5best/valid/score_wer/ref.trn"
    )
)
valid_hyp_write = open(
    os.path.join(
        exp_root, "inference_asr_model_valid.acc.ave_5best/valid/score_wer/hyp_asr.trn"
    ),
    "w",
)
valid_ref_write = open(
    os.path.join(
        exp_root, "inference_asr_model_valid.acc.ave_5best/valid/score_wer/ref_asr.trn"
    ),
    "w",
)
...
test_hyp_write = open(
    os.path.join(
        exp_root, "inference_asr_model_valid.acc.ave_5best/test/score_wer/hyp_asr.trn"
    ),
    "w",
)
test_ref_write = open(
    os.path.join(
        exp_root, "inference_asr_model_valid.acc.ave_5best/test/score_wer/ref_asr.trn"
    ),
    "w",
)
