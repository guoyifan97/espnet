...
class Universal_Frontend_Time_Attention_Pos_Enc(nn.Module):
    '''
        A univeral frontend,
...
class BeamformingLayerAoLiAo(nn.Module):
    ...
    def forward(self, x_channel_r, x_channel_i, x_channel_mask):
        ...
        x_channel_r, x_channel_i = self.dropout(*self.channel_wise_att_module([x_channel_r, x_channel_i], [x_channel_r, x_channel_i], [x_channel_r, x_channel_i], None))
